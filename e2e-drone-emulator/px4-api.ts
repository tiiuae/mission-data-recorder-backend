...
export class PX4Api {
    private publisherMissionResult: rclnodejs.Publisher<"px4_msgs/msg/MissionResult">;
    ...
    constructor(private node: rclnodejs.Node) {
        ...
        this.publisherMissionResult = this.node.createPublisher(
            "px4_msgs/msg/MissionResult",
            "MissionResult_PubSubTopic",
            opt
        );
    ...
    publishMissionResult(msg: rclnodejs.px4_msgs.msg.MissionResult) {
        this.publisherMissionResult.publish(msg);
    }
